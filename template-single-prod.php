<?php
/* Template Name: Single Produto - Decoratum */
...
<section class="product-cake sec-prod-single">
    <div class="container">
        <div id="hold-nome-produto">
            <h1>Maleta Porta Maquiagem 50x60</h1>
        </div>
        <div class="row">
            <div class="col-md-7">
                <div class="slider-prod-single">
                    <div class="img-relative">
                        <img alt="Trufa Tradicional" src="https://img.elo7.com.br/product/original/C1EC20/kit-cartonagem-mala-quadrada-cartonagem.jpg" />
                    </div>

                    <div class="img-relative">
                        <img alt="Trufa Tradicional" src="https://img.elo7.com.br/product/original/BDC633/kit-cartonagem-caixa-bijoux-com-gaveta-bijoux.jpg" />
                    </div>

                    <div class="img-relative">
                        <img alt="Trufa Tradicional" src="https://farm4.static.flickr.com/3790/8883685240_120c9af8ca_b.jpg" />
                    </div>
                </div>
            </div>
