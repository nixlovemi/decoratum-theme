            ...
            <div class="col-sm-4">
                ...
                <p align="center">
                    <a href="https://pagseguro.uol.com.br/para_voce/passo_a_passo.jhtml#rmcl" target="_blank">
                        <img class="img-responsive" alt="Saiba Mais - PagSeguro" src="http://fantasya.com.br/blogmarina/wp-content/uploads/2014/05/pagseguro-footer.png" />
                    </a>
                </p>

                <button style="width: 100%; font-size:18px;" type="button" title="Consultar" class="button btn-frete mt-10 mb-20 ft-l" id="btn-cons-frete" onclick="alert(123)">
