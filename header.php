...
<html class="no-js" lang="pt-br">
  <head>
    ...
    <meta content="Sonho de Trufa - Trufas Tradicionais" name="description" />
              ...
              <div class="top-header">
                <div class="container">
                  <div class="navbar-header visible-xs">
                    ...
                    <img alt="Logo Sonho de Trufa" src="<?php bloginfo('template_url'); ?>/images/logo-100.png" />
                    </a>
                  </div>
                  <nav>
                    <ul class="header-nav hidden-xs">
                      ...
                      <li class="pad-top-0i">
                        <img alt="Logo Sonho de Trufa" src="<?php bloginfo('template_url'); ?>/images/logo-150.png" />
                      </li>
                      <li>
                      	<?php
